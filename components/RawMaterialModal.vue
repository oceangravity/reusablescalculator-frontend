    ...
    <template #body="{ close }">
      <div class="flex flex-col relative justify-center items-center">
        ...
        <div class="flex w-full relative justify-center items-center pb-5">
          ...
          <div class="columns-2 w-full max-h-[400px] columns-2 text-[14px] bg-white flex-1 gap-x-10 gap-y-2 px-6 p-5">
            <div v-for="option in store.rawMaterialOptions" :key="option.id" class="flex w-full items-center gap-1 cursor-pointer hover:text-gray-400 select-none">
